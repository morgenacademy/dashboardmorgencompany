...
//
// Verplicht : MS_TENANT_ID, MS_CLIENT_ID, MS_CLIENT_SECRET
// Optioneel : SHAREPOINT_HOST  → tenant-host (default hieronder)
...
async function msGraphToken() {
  ...
  if (!tenant || !clientId || !secret) {
    return { error: 'Microsoft Graph niet gekoppeld (MS_TENANT_ID / MS_CLIENT_ID / MS_CLIENT_SECRET ontbreken)' };
  }
  try {
